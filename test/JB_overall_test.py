...
from JB_Contig_Test.JB_Contig_TestServer import MethodContext


class JB_Contig_TestTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('JB_Contig_Test'):
            cls.cfg[nameval[0]] = nameval[1]
        cls.wsURL = cls.cfg['workspace-url']
        cls.wsClient = workspaceService(cls.wsURL, token=token)
        cls.serviceImpl = JB_Contig_Test(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_JB_Contig_Test_" + str(suffix)
